<?php
	if(isset($_POST['enviar'])):
		if(!empty($_POST['check_cedulas'])):
			require_once "conexionBD.php";
			foreach($_POST['check_cedulas'] as $ced):
				$datos = $conexion->prepare("delete from registrogrupo where cedula=?");
				$datos->bind_param('s',$ced);
		...
		else:echo "<link rel='stylesheet' href='http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css'>
